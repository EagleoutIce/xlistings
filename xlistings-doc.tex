...
\usepackage[fakeminted,style={plain number}]{xlistings}
...
\xlstlangoverride{latex}{morekeywords=[5]{\\xlstsetstyle,\\xlstlangoverride,\\LoadLanguages}}
...
\begin{itemize}[nosep,itemsep=6pt,leftmargin=*]
    \item Highlighting of numbers in code blocks: \bjava{1234 + x * 0x34}
